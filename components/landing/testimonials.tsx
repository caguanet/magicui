  ...
  return (
    <section id="testimonials" className="container py-14">
      ...
      <div className="relative flex flex-col">
        ...
        <div className="pointer-events-none absolute inset-y-0 left-0 h-full w-1/3 bg-gradient-to-r from-neutral-50 dark:from-[#070708] "></div>
        <div className="pointer-events-none absolute inset-y-0 right-0 h-full  w-1/3 bg-gradient-to-l from-neutral-50 dark:from-[#070708]"></div>
      </div>
    </section>
  );
}
